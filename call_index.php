...
function call_daumEditor(){
    echo '<link type="text/css" rel="stylesheet" href="/lecture_board/daumeditor/css/editor.css" charset="utf-8"/>
    <script type="text/javascript" src="/lecture_board/daumeditor/js/editor_loader.js?environment=development" charset="utf-8"></script>';
}
...
function call_lnb(){
    echo '<div id="nav-left" class="nav-left">
		...
		<ul class="nav-left-lst">
			...
			<li><a href="#">학습안내</a></li>
			<li class="on"><a href="/index.php?mode=list">수강후기</a></li>
		</ul>
	</div>
